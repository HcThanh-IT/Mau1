google.maps.__gjsload__('map', function(_) {
    var Bta = function(a) {
        ...
        dB = function(a) {
            return (a = _.Uq(a.Eg)) && _.Y(a.Gg, 2) && _.Y(_.J(a.Gg, 2, Ota).Gg, 3, Pta) ? _.J(_.J(a.Gg, 2, Ota).Gg, 3, Qta, Pta) : null
        },
        Rta = function(a) {
            if (!a.Eg) return null;
        ...
        aua = function(a) {
            if (!a) return null;
            a = a.toLowerCase();
            return Zta.hasOwnProperty(a) ? Zta[a] : $ta.hasOwnProperty(a) ? $ta[a] : null
        },
        bua = function(a, b) {
            let c = null;
            a && a.some(d => {
        ...
        dua = function(a, b, c, d, e, f, g, h, k = !1, m = !1) {
            const p = new _.vy;
            p.initialize(a, b, c != "hybrid");
            (c === "satellite" || c === "hybrid" && !m) && Kta(p);
        ...
        eua = function(a, b, c, d, e, f, g, h, k, m, p, t = !1) {
            const u = [];
            (e = cua(e, k, c)) && u.push(e);
            e = new _.Ov;
            _.Lv(e, 37);
            _.Jv(_.Nv(e), "smartmaps");
            u.push(e);
            return {
                Im: dua(a, b, c, d, u, f, k, p, m, t),
                qo: g,
                scale: h
            }
        },
        ...
        eB = function(a, b, c, d = {
            ...
            if (b === "satellite" && h) {
                var k;
                h ? k = Lta(a.Ig, e || 0) : k = cB(_.J(a.Ig.Eg.Gg, 2, _.kx));
                b = new _.xy({
                    hh: 256,
                    kh: 256
                }, h ? 45 : 0, e || 0);
                return new hua(k, f && _.Xn() > 1, _.Ew(e), g && g.scale || null, b, h ? a.Lg : null, !!d, a.Jg)
            }
            return new _.zy(_.Aw(a.Ig), "Xin l\u1ed7i, ch\u00fang t\u00f4i kh\u00f4ng c\u00f3 h\u00ecnh \u1ea3nh \u1edf \u0111\u00e2y.", f && _.Xn() > 1, _.Ew(e), c, g, e, a.Jg, a.Kg, !!d)
        },
        kua =
        function(a) {
            function b(c, d) {
        ...
        mua = function(a, b) {
            return new fB(lua(a), a.Eg, typeof b === "number" ? new _.fm(b) : a.projection, typeof b === "number" ? 21 : 22, "K\u1ebft h\u1ee3p", "Hi\u1ec3n th\u1ecb h\u00ecnh \u1ea3nh c\u00f3 t\u00ean ph\u1ed1", _.tx.hybrid, `m@${a.Hg}`, {
                type: 68,
                params: {
        ...
        function(a, b) {
            ...
            return new fB(nua(a), null, typeof b === "number" ? new _.fm(b) : a.projection, c ? 21 : 22, "V\u1ec7 tinh", "Hi\u1ec3n th\u1ecb h\u00ecnh \u1ea3nh qua v\u1ec7 tinh", c ? "a" : _.tx.satellite, null, null, "satellite", !1, a.Fg, a.language, a.region, b, a.map)
        },
        pua = function(a, b) {
        ...
        qua = function(a, b, c, d = {}) {
            ...
            if (b === "hybrid") {
                ...
                b = oua(a);
                b.Fg = {};
                for (const f of e) b.Fg[f] =
                    oua(a, f)
            } else b = b === "roadmap" && _.Xn() > 1 && d ? new fB(kua(a), a.Eg, a.projection, 22, "B\u1ea3n \u0111\u1ed3", "Hi\u1ec3n th\u1ecb b\u1ea3n \u0111\u1ed3 ph\u1ed1", _.tx.roadmap, `m@${a.Hg}`, {
                type: 68,
                params: {
                    set: "Roadmap"
                }
            }, "roadmap", !1, a.Fg, a.language, a.region, void 0, a.map) : b === "terrain" ? new fB(pua(a, "terrain"), a.Eg, a.projection, 21, "\u0110\u1ecba h\u00ecnh", "Hi\u1ec3n th\u1ecb b\u1ea3n \u0111\u1ed3 ph\u1ed1 v\u1edbi \u0111\u1ecba h\u00ecnh", _.tx.terrain, `r@${a.Hg}`, {
                    type: 68,
                    params: {
                        set: c ? "TerrainDark" : "Terrain"
                    }
                },
                "terrain", c, a.Fg, a.language, a.region, void 0, a.map) : new fB(pua(a, "roadmap"), a.Eg, a.projection, 22, "B\u1ea3n \u0111\u1ed3", "Hi\u1ec3n th\u1ecb b\u1ea3n \u0111\u1ed3 ph\u1ed1", _.tx.roadmap, `m@${a.Hg}`, {
                type: 68,
                params: {
        ...
        rua = function(a, b = !1) {
            const c = _.cn.Pg ? "S\u1eed d\u1ee5ng \u2318 + cu\u1ed9n \u0111\u1ec3 thu ph\u00f3ng b\u1ea3n \u0111\u1ed3" : "S\u1eed d\u1ee5ng ctrl + cu\u1ed9n \u0111\u1ec3 thu ph\u00f3ng b\u1ea3n \u0111\u1ed3";
            a.Ng.textContent = b ? c : "S\u1eed d\u1ee5ng hai ng\u00f3n tay \u0111\u1ec3 di chuy\u1ec3n b\u1ea3n \u0111\u1ed3";
        ...
        vua = function(a) {
            return new _.hy([a.draggable, a.AH, a.Ck], uua)
        },
        ...
        hB = function(a, b, c) {
            function d() {
                var k = a.__gm,
                    m = k.get("baseMapType");
                m && !m.Ip &&
                    (a.getTilt() !== 0 && a.setTilt(0), a.getHeading() !== 0 && a.setHeading(0));
                var p = hB.oI(a.getDiv());
                p.width -= e;
                p.width = Math.max(1, p.width);
                p.height -= f;
                p.height = Math.max(1, p.height);
                m = a.getProjection();
                p = hB.pI(m, b, p, a.get("isFractionalZoomEnabled"));
                ...
                if (_.xj(p) && u) {
                    ...
                    w = a.getCenter();
                    k.get("isInitialized") &&
                        u && w && p && p === a.getZoom() ? (k = _.dr(t, _.ts(w, m)), m = _.dr(t, _.ts(u, m)), a.panBy(m.hh - k.hh, m.kh - k.kh)) : (a.setCenter(u), a.setZoom(p))
                }
            }
            let e = 80,
                f = 80,
        ...
        Fua = function(a, b) {
            if (b) {
                ...
                b instanceof _.Qn && (c = "Ots", d = 150782);
                a.Jg(c, d)
            }
        },
        Gua = function(a, b) {
        ...
        Nua = async function(a) {
            const b = a.map.__gm;
            var c = b.get("blockingLayerCount") || 0;
            b.set("blockingLayerCount", c + 1);
            await zua(a.Eg, a.mapId);
            c = a.Eg.Eg;
            const d = a.Eg.Lj;
        ...
        Qua = function(a, b) {
            const c = a.__gm;
            b = new Pua(a.mapTypes, c.gk, b, c.zp, a);
            b.bindTo("heading", a);
        ...
        Sua = function(a) {
            return a >= 15.5 ? 67.5 : a > 14 ? 45 + (a - 14) * 22.5 / 1.5 : a > 10 ? 30 + (a -
                10) * 15 / 4 : 30
        },
        mB = function(a) {
            if (a.get("mapTypeId")) {
                var b = a.set; {
                    ...
                    if (a.Eg) {
                        ...
                        var e = Sua(c);
                        d = d > e ? e : d
                    } else d = Tua(a), d == null ? d = null : (e = _.xj(f) && f > 22.5, c = !_.xj(f) && c >= 18, d = d && (e || c) ? 45 : 0)
                }
                b.call(a, "actualTilt", d);
                a.set("aerialAvailableAtZoom", Tua(a))
            }
        },
        Uua = function(a, b) {
            (a.Eg = b) && mB(a)
            ...
            if (!a.isEmpty()) {
                ...
                (e || f || g.length || h) && _.Ck(b, "maptypeid_changed", () => {
                    ...
                    if (b.get("mapTypeId") === "roadmap") {
                        ...
                        null), c.set("hasCustomStyles", !1), g.forEach(p => {
                        m = m.Un(p)
                ...
                if (a.Ig ? !a.Eg : !a.Eg || d || f) {
                    ...
                    try {
                        ...
                        a.map.get("isFractionalZoomEnabled") || Math.round(p) === p || typeof p !== "number" ||
                            (_.pl(a.map, "BSzwf"), _.M(a.map, 149837));
        ...
        Zua = function(a) {
            ...
            for (const g of a) {
                ...
                c = d && Xua[d.toLowerCase()];
                (c = c != null ? c : null) && f.push(`s.e:${c}`);
                d != null && c == null &&
                    _.Nj(_.Mj(`invalid style element type: ${d}`, null));
                if (e)
                    for (const k of e) {
                        a: {
                            d = k;
                            for (const m of Object.keys(d))
                                if (e = d[m], (c = m && Yua[m.toLowerCase()] || null) && (_.xj(e) || _.Bj(e) || _.Cj(e)) && e) {
                                    d = `p.${c}:${e}`;
                                    break a
                                }
                            d = void 0
        ...
        $ua = function(a, b) {
            ...
            Vta(c, b);
            b = a.get("uDS") ? a.get("mapTypeId") === "hybrid" ? "" : "p.s:-60|p.l:-60" : Zua(c);
        ...
        iva = function(a, b, c, d) {
            ...
            a.Kg ? (a.Kg = !1, _.Fi(e.Gg, 12, 1), e.setUrl(a.Qg.substring(0, 1024)), _.Ci(e.Gg, 14, !0), a.map.Eg || (a = Hta(_.Tja(), a.map).toString(), _.Xg(e.Gg, 17, a))) : _.Fi(e.Gg, 12, 2);
            return e
        },
        jva = function(a, b, c,
            d) {
            if ((_.H(d.Gg, 8) !== 1 || ova(a, d)) && b === a.Mg) {
                ...
                a.Ig && pva(a.Ig, _.J(d.Gg, 4, qva));
                var f = {};
                for (let h = 0, k = _.ui(d.Gg, 2); h < k; ++h) c = _.Qq(d.Gg, 2, rva, h), b = c.getFeatureName(), c = _.J(c.Gg, 2, _.wx), c = dva(c), f[b] = f[b] || [], f[b].push(c);
                _.rf(a.Eg, (h, k) => {
                ...
                a.Pg = c;
                for (e = 0; e < b; ++e) {
                    var g = _.Qq(d.Gg, 3, sva, e);
                    const h = _.Si(g.Gg,
                        1);
                    g = dva(_.J(g.Gg, 2, _.wx));
                    c[e] = {
                        bounds: g,
                        maxZoom: h
                    }
        ...
        oB = function(a, b = -Infinity, c = Infinity) {
            return b > c ? (b + c) /
                2 : Math.max(Math.min(a, c), b)
        },
        vva = function(a, b) {
            return a.isConnected || b.isConnected ? a.isConnected ? b.isConnected ? a.compareDocumentPosition(b) & Node.DOCUMENT_POSITION_DISCONNECTED ? tva(a, b) : uva(a, b) : -1 : 1 : 0
        },
        uva = function(a, b) {
        ...
        tva = function(a, b) {
            ...
            const g = c.indexOf(f);
            f = d.indexOf(f);
            return uva(g > 0 ? xva(c[g - 1]) : a, f > 0 ? xva(d[f - 1]) : b)
        },
        wva = function(a) {
            const b = [];
                ...
                if (c !== !1) {
                    ...
                    if (c !== "none" && (c !== "cooperative" || !d) && (_.ok(b), d = a.ah.yk())) {
                        ...
                        !f && (e > 0 && e < a.Fg || e < 0 && e > a.Fg) ? a.Fg = e : (a.Fg = e, a.Eg += e, a.Ig.dr(), !f && Math.abs(a.Eg) < 16 || (f ? (Math.abs(a.Eg) > 16 && (a.Eg = _.Zr(a.Eg < 0 ? -16 : 16, a.Eg, .01)), e = -(a.Eg / 16) / 5) : e = -Math.sign(a.Eg), a.Eg = 0, b = c ===
                            "zoomaroundcenter" ? d.center : a.ah.El(b), f ? a.ah.IF(e, b) : (c = Math.round(d.zoom + e), a.Hg !== c && (Cva(a.ah, c, b, () => {
                                a.Hg = null
                            }), a.Hg = c)), a.Gm(1)))
                    }
                }
        ...
        Jva = function(a, b, c, d = () => "greedy", {
                    ...
                    if (x) {
                        ...
                        if (x.enabled() && (w = x.Fg(4), w !== "none")) {
                            ...
                            B && (z = B.zoom + (z ? -1 : 1), x.Eg() || (z = Math.round(z)), u = w === "zoomaroundcenter" ?
                                x.ah.yk().center : x.ah.El(u), Cva(x.ah, z, u), x.Gm(1))
                        }
                    }
                }
            };
            ...
            new Fva(b.Kn, a, d, g, p, k);
            const t = new Gva(a, d, e, p, k);
            h.lq = new Hva(a, d, m, c, k);
            f && (h.MH = new Iva(a, m, c, k));
            return m
        },
        uB = function(a, b, c) {
        ...
        wB = function(a) {
            a.Kg || (a.Kg = !0, a.requestAnimationFrame(b => {
                ...
                if (a.instructions) {
                    ...
                    c && (e === 0 && a.Ig ? Pva(a.th, c, b, !1) : (a.th.Xh(c, b, d.Zj), e !== 1 && e !== 0 || wB(a)));
                    c && !d.Zj && a.Hg(c)
                } else a.camera && Pva(a.th, a.camera, b, !0);
                a.Ig = !1
            }))
        },
        ...
        Vva = function(a, b, c = {}) {
            const d =
                c.UG !== !1,
                e = !!c.Gx;
            return new Rva(f => new Sva(a, f, {
                Gx: e
            }), (f, g, h, k) => new Tva(new Uva(f, g, h), {
                Ml: k,
                maxDistance: d ? 1.5 : 0
            }), b)
        },
        ...
        Bwa = function(a, b, c, d, e, f) {
            ...
            if (m)
                if (Array.from(new Set([42]))[0] !== 42) _.Sw(m);
                    ...
                    z.textContent = "\u0110\u1ec3 di chuy\u1ec3n b\u1ea3n \u0111\u1ed3 b\u1eb1ng c\u1eed ch\u1ec9 ch\u1ea1m, h\u00e3y nh\u1ea5n \u0111\u00fap v\u00e0 gi\u1eef ng\u00f3n tay c\u1ee7a b\u1ea1n tr\u00ean b\u1ea3n \u0111\u1ed3, sau \u0111\u00f3 k\u00e9o b\u1ea3n \u0111\u1ed3.";
                    ...
                    (function() {
                        const Ga = new lwa;
                        F = Jua(Ga, T, a, qa, V);
                        I = new mwa(g, B, C, qa ? null : Ga, _.Ms(), D, a)
                    })();
                    I.bindTo("tilt", a);
                    I.bindTo("heading", a);
                    I.bindTo("bounds", a);
                    I.bindTo("zoom", a);
                    m = new nwa(_.Hi(_.Mi.Gg, 2, _.yw), _.Vq(), _.Mi.Eg(), a, F, C.obliques, h.Eg);
                    Yva(m, p, a.mapTypes, b.enableSplitTiles);
                    ...
                    var Ca = vua({
                        ...
                        tc = Ga => {
                            a.get("tilesloading") != Ga && a.set("tilesloading",
                                Ga);
                    ...
                    h.en.then(Ga => {
                        ...
                        ob === "VECTOR" ?
                            _.M(a, 206144) : ob === "RASTER" ? _.M(a, 206145) : ob = Rta(Ga) ? "VECTOR" : "RASTER";
                        ob === "VECTOR" ? (_.pl(a, "Wma"), _.M(a, 150152), _.jj("webgl").then(pb => {
                            ...
                            let zb = V;
                            Cta() && (yb = null, zb = void 0);
                            try {
                                Xb = pb.Mg(t.Kn, Me, Sb, Ha.Hg, Ga, _.Mi.Eg(), yb, _.Aw(Bd, !0), cB(_.J(Bd.Eg.Gg, 2, _.kx)), a, zb, Sd, Qb)
                            } catch (hd) {
                                let Nb = hd.cause;
                                hd instanceof _.Tpa && (Nb = 1E3 + (_.xj(hd.cause) ?
                                    hd.cause : -1));
                                _.pj(Jc, Nb != null ? Nb : 2);
                                Cb = !0
                            } finally {
                                Cb ? (h.Pv(!1), _.Fj("Attempted to load a Vector Map, but failed. Falling back to Raster. Please see https://developers.google.com/maps/documentation/javascript/webgl/support for more info")) : (_.pj(Jc, 0), (0, _.Npa)() || _.M(a, 212143), h.Pv(!0), h.Xi = Xb, h.set("configVersion", Xb.Ng()), Sb.wB(Xb.Pg()))
                            }
                        })) : h.Pv(!1)
                    });
                    h.Hg.then(Ga => {
                    ...
                    m = new _.Ey(h, "cursor");
                    var Ze = new rwa(h.get("messageOverlay")),
                    ...
                    Promise.all([h.Hg, h.en]).then(([Ga, ob]) => {
                        ...
                        Xva(Sb, () => a.get("isFractionalZoomEnabled"));
                        const pb = () => {
                            const Xb = Ga && fwa(a, ob),
                                Cb = Ga && gwa(a, ob);
                            Ga || !a.get("tiltInteractionEnabled") &&
                                !a.get("headingInteractionEnabled") || _.mk("tiltInteractionEnabled and headingInteractionEnabled only have an effect on vector maps.");
                            ...
                            hb.wi.lq = new twa(Sb, xa, hb, Xb, Cb, Ua, kB);
                            Xb || Cb ? hb.wi.VE = new uwa(Sb, hb, Xb, Cb, Ua, kB) : hb.wi.VE = void 0
                        };
                        pb();
                    ...
                    a.Eg || (eb = function() {
                        ...
                        Promise.all([_.jj("controls"), h.Hg, h.en]).then(([Ga, ob, pb]) => {
                            const Xb = t.Eg,
                                Cb = new Ga.jC(Xb, Fta(a));
                            _.sk(a,
                                "shouldUseRTLControlsChange", () => {
                                    Cb.set("isRTL", Fta(a))
                                });
                            h.set("layoutManager", Cb);
                            const yb = ob && fwa(a, pb);
                            pb = ob && gwa(a, pb);
                            Ga.xJ(Cb, a, Ha, Xb, I, C.report_map_issue, Id, jd, t.Cq, c, h.Il, F, sa, Sb, ob, yb, pb, p);
                            Ga.yJ(a, t.Uj, Xb, x, yb, pb);
                            Ga.CB(c)
                        })
                    }, _.pl(a, "Mm"), _.M(a, 150182), Zva(a, Ha), Mua(a), _.Ek(h, "mapbindingcomplete"));
                    f = new nwa(_.Hi(_.Mi.Gg, 2, _.yw), _.Vq(), _.Mi.Eg(), a, new jB(F, function(Ga) {
                        return qa ? V : Ga || T
                    }), C.obliques, h.Eg);
                    Ava(f, a.overlayMapTypes);
                    Dua((Ga, ob) => {
                            _.pl(a, Ga);
                            _.M(a, ob)
                        }, t.Nl.mapPane, a.overlayMapTypes,
                        Sb, b, Aa);
                    ...
                    _.yk(sc, "load", () => {
                        ke();
                        _.yk(sc.contentWindow,
                            "resize", ke)
                    });
                    t.Eg.appendChild(sc);
                    b = _.Cda(t.Uj, void 0, !0);
                    t.Eg.appendChild(b)
                }
    ...
    var Qta = class extends _.W {
            constructor(a) {
                super(a)
            }
        },
        Ota = class extends _.W {
            constructor(a) {
                super(a)
            }
        },
        Pta = _.Oq(1, 2, 3, 4),
        Cwa = class extends _.vq {
            constructor(a) {
                super(a);
                ...
                this.oj(a, Cwa, "ModalOverlayView")
            }
            Mg(a) {
                ...
                if (this.ownerElement.contains(this.element)) {
                    ...
                    var b = $A(this, document.body),
                        c = a.target,
                        d = Ita(this, b);
                    a.target === this.Eg ? (c = d.XI, a = d.fA, d = d.PD, this.element.contains(this.Hg) ? (--c, c >= 0 ? aB(b[c]) : aB(b[d - 1])) : aB(b[a + 1])) : a.target === this.Fg ? (c = d.fA, a = d.PD, d = d.YI, this.element.contains(this.Hg) ? (d += 1, d < b.length ? aB(b[d]) : aB(b[c + 1])) : aB(b[a - 1])) : (d = d.fA,
            ...
            Kj() {
                this.element.style.display !== "none" && (this.Fo && this.Fo.removeAttribute("aria-hidden"), _.Ek(this, "hide", void 0), this.Ig && this.Ig.remove(), _.Oia(this.Jg), this.element.style.display = "none", Gta(this.Kg).catch(() => {
                    this.Gr && this.Gr()
                }))
            }
        },
        ...
        tB = class extends fB {
            constructor(a, b, c, d, e, f) {
                ...
                this.Kg = gua(this.mapTypeId, this.__gmsd, b, e, f);
                this.Ip && this.mapTypeId === "satellite" || this.Hg.set(eua(this.Lg, this.Mg, this.mapTypeId, this.Og, this.__gmsd, b, c, d, e, !!this.Jg ? .get("mapId"), f, this.Ip))
            }
        },
        Ewa = class {
        ...
        iua = class {
            ...
            Kk(a, b = {}) {
                ...
                return new Ewa(c, d, this.Dh.size, this.Eg, {
                    Ti: b.Ti
                })
            }
        },
        ...
        hua = class {
            constructor(a, b, c, d, e, f, g = !1, h) {
                this.errorMessage = "Xin l\u1ed7i, ch\u00fang t\u00f4i kh\u00f4ng c\u00f3 h\u00ecnh \u1ea3nh \u1edf \u0111\u00e2y.";
                this.Jg = b;
                this.Fg = c;
                this.scale = d;
                this.Dh = e;
            ...
            Kk(a, b) {
                ...
                return new Fwa(a, this.Eg, this.Jg, this.Fg, this.scale, this.Dh, this.Rg, this.Hg)
            }
        },
        Gwa = [{
            uy: 108.25,
    ...
    var rwa = class {
        ...
        Eg(a) {
            ...
            a === 1 ? (rua(this, !0), this.Fg = setTimeout(() => {
                sua(this)
            }, 1500)) : a === 2 ? rua(this, !1) : a === 3 ? sua(this) : a === 4 && (this.Yg.style.transitionDuration = "0.2s", this.Yg.style.opacity = "0", this.Yg.style.display =
                "none")
        }
    };
    var qwa = class {
        constructor(a, b, c, d) {
            ...
            _.du(c.Cq, {
                ...
                Gq: e => {
                    this.ah.vx() || (this.Fg = e, Date.now() - this.Hg > 5 && wua(this))
                },
                Ek: e => {
    ...
    var Cua = class {
        constructor(a, b, c, d, e, f) {
            ...
            _.sk(c, "remove_at", h => {
                const k = this.Eg[h];
                k && (this.Eg.splice(h, 1), Gua(this), k.clear())
            });
            _.sk(c, "set_at", h => {
    ...
    var pwa = class {
        constructor(a, b, c) {
            this.map = a;
            this.mapId = b;
            this.Eg = new Iwa(() => new _.qg);
            b ? (a = b ? c.Hg[b] || null : null) ? lB(this, a, _.Wq(_.Mi.Gg, 41)) : Nua(this) : lB(this, null, null)
        }
    };
    var Pua = class extends _.Hk {
        constructor(a, b, c, d, e) {
            super();
            this.mv = a;
    ...
    var vwa = class extends _.Hk {
        changed(a) {
            if (a !== "apistyle" && a !== "hasCustomStyles") {
                ...
                if (a === "styles") try {
                    if (b)
                        for (const c of b) c && c.featureType && aua(c.featureType) && (_.pl(this, c.featureType), c.featureType in Lwa && _.M(this, Lwa[c.featureType]))
                } catch (c) {}
            }
        }
        getApistyle() {
    ...
    var Mwa = class extends _.Fy {
        constructor() {
            super([new _.Cpa])
        }
    };
    var mwa = class extends _.Hk {
        constructor(a, b, c, d, e, f, g) {
            super();
            this.language = a;
            this.Lg = b;
        ...
        changed(a) {
            a !== "attributionText" && (a === "baseMapType" && (lva(this), this.Hg = null), _.Om(this.Og))
        }
        getMapTypeId() {
    ...
    var hwa = class {
        constructor(a) {
            ...
            this.Qg = d => {
                ...
                if (f.Bk) d.key === "Escape" && f.sx(d);
                    ...
                    var g = !1,
                        h = null;
                    if (_.Vw(d) || _.Ww(d)) this.Eg.size <= 1 ? h = null : (g = yva(this), h = g.length, h = g[(g.indexOf(e) - 1 + h) % h]), g = !0;
                    else if (_.Xw(d) || _.Yw(d)) this.Eg.size <=
                        1 ? h = null : (g = yva(this), h = g[(g.indexOf(e) + 1) % g.length]), g = !0;
        ...
        set Rg(a) {
            ...
            b.id = this.Jg;
            b.textContent = "\u0110\u1ec3 di chuy\u1ec3n gi\u1eefa c\u00e1c y\u1ebfu t\u1ed1 t\u01b0\u01a1ng t\u00e1c, h\u00e3y nh\u1ea5n c\u00e1c ph\u00edm m\u0169i t\u00ean.";
    ...
    var Iva = class {
        ...
        fn(a) {
            if (this.active) {
                a = this.active.mK + (a.yi.clientY - this.active.origin.clientY) / 128;
                var {
                    center: b,
                    heading: c,
                    tilt: d
    ...
    var Hva = class {
        ...
        fm(a, b) {
            ...
            d === "none" || d === "cooperative" && c || (b.stop(), this.active ? this.active.kn = Eva(this, a) : (this.cursor && _.ex(this.cursor, !0), (c = yB(this.ah, () => {
                this.active = null;
                this.ak.reset(b)
            })) ? this.active = {
                kn: Eva(this, a),
    ...
    var uwa = class {
        ...
        fm(a, b) {
            b.stop();
            if (this.active) this.active.kn = Kva(this, a);
            else {
                this.cursor && _.ex(this.cursor, !0);
                var c = yB(this.ah, () => {
                    this.active = null;
    ...
    var Owa = class {
        ...
        Uva = class {
            constructor(a, b, c) {
                ...
                a = new Owa(b.center.Eg / d, b.center.Fg / e, .5 * Math.pow(2, -b.zoom));
                const f = new Owa(c.center.Eg / d, c.center.Fg / e, .5 * Math.pow(2, -c.zoom));
    ...
    var Qwa = class {
        ...
        ck(a, b, c = () => {}) {
            a = this.Eg.Ct(a);
            this.camera && b ? this.Fg(this.Lg(this.th.getBoundingClientRect(!0), this.camera, a, c)) : this.Fg(Mva(a, c))
        }
        Jg() {
        ...
        qB(a) {
            ...
            !this.instructions && this.camera && (a =
                this.Eg.Ct(this.camera), a.center === this.camera.center && a.zoom === this.camera.zoom && a.heading === this.camera.heading && a.tilt === this.camera.tilt || this.Fg(Mva(a)))
        }
        Ru() {
            return this.Eg.Ru()
        }
    ...
    var Sva = class {
        ...
        Xh(a, b, c) {
            ...
            if ((f || this.Fg) && this.offset) this.origin = Eta(e, _.$q(d, _.xm(e, this.offset)));
            else if (this.offset =
    ...
    var Wva = class {
            ...
            release(a) {
                ...
                if (!(this.Fg.length <=
                        0) && this.Eg) {
                    var c = Tta(this.Fg, e => b - e.aj < 125 && this.Eg.aj - e.aj >= 10);
                    c = c < 0 ? this.Eg : this.Fg[c];
                    var d = this.Eg.aj - c.aj;
                    switch (Qva(this, c.camera, a)) {
                        case 3:
                            a = new Rwa(this.Eg.camera, -180 + _.Yr(this.Eg.camera.heading - c.camera.heading - -180, 360), d, b, a || this.Eg.camera.center);
                            break;
                        case 2:
                            a = new Swa(this.Eg.camera, c.camera, d, a || this.Eg.camera.center);
                            break;
                        case 1:
                            a = new Twa(this.Eg.camera, c.camera, d);
                            break;
                        default:
                            a = new Uwa(this.Eg.camera, c.camera, d, b)
                    }
                    this.Jg(new Vwa(a, b))
                }
            }
    ...
    var Rva = class {
        constructor(a, b, c) {
            ...
            this.controller = new Qwa(this.Eg, b, {
                Ct: d => d,
                Ru: () => ({
                    min: 0,
                    max: 1E3
        ...
        IF(a, b) {
            var c = () => {};
            let d;
            if (d = Ova(this.controller) === 0 ? Nva(this.controller) : this.yk()) {
                a = d.zoom + a;
