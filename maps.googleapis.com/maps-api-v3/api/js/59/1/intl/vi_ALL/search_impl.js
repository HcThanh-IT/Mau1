    ...
    var Eyb = function(a, b) {
        ...
        Hyb = function(a) {
            if (_.an[15]) {
                ...
                b && a.Eg && (a.Hg ? (b = b.__gm.gk, b.set(b.get().Un(a.Eg))) : a.Eg && _.oZa(a.Eg, b) && ((a.Fg || []).forEach(_.uk), a.Fg = null));
                if (c) {
                    b = new _.Nw;
                    ...
                    a.Hg ? (a = c.__gm.gk, a.set(_.fr(a.get(), b))) : Gyb(a, c, b);
                    _.pl(c, "Lg");
                    _.M(c, 148282)
                }
            }
        ...
        Gyb = function(a, b, c) {
            ...
            b = [];
            b.push(_.sk(c,
                "click", Jyb.bind(null, a)));
            for (const e of ["mouseover", "mouseout", "mousemove"]) b.push(_.sk(c, e, Kyb.bind(null, a, e)));
    ...
    var Iyb = class {
        constructor() {
            var a = _.go,
                b = _.fo;
            this.Eg = _.Mi;
            this.fetch = _.fx.bind(Lyb, a, _.by + "/maps/api/js/LayersService.GetFeature", b)
        }
        load(a, b) {
            function c(e) {
                b(new Oyb(e))
