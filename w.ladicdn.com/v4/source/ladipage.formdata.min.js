LadiPageScriptV2.prototype.parseFormCheckoutProduct = function(e) {
        ...
        if (1 === o.length) {
            ...
            ($ = n.parseFormCheckoutProduct(c)).quantity = 1;
            var d = c.querySelector(".ladi-form-checkout-payment-quantity input");
            isEmptyLadiPage(d) || ($.quantity = parseInt(d.value) || $.quantity), r.push($)
        ...
        var s = isObjectLadiPage(n.runtime.payment_setting) ? n.runtime.payment_setting : {},
            ...
            T = 0,
            x = function(e, t) {
                return e = window.ladi(e).get_url(p, t, !1)
            },
            S = function(a) {
            ...
            N = function(e, t) {
                "Success" == e && S(t.thanks_url), "Canceled" == e && n.showMessage(n.const.LANG.FORM_CHECKOUT_ORDER_CANCEL)
            };
                ...
                if (i && o ? i.style.display = "none" : i && (i.style.display = ""), isEmptyLadiPage(document.getElementById(t))) {
                    ...
                    a.style.display = "block", i.style.display = "none", o.style.display = "block",
                        function e() {
                            ...
                            a.textContent = `${String(s).padStart(2,"0")} phút ${String(u).padStart(2,"0")} giây`, d > 0 ? T = n.runTimeout(e, 1e3) : (i.style.textAlign = "center", i.style.display = "block", i.style.color = "#E01A1A", i.style.maxWidth = "632px", o.style.display = "block", t.style.display = "none", r.style.display = "none", w = !0)
                        }()
                }(5), A = !0);
                var r = new XMLHttpRequest;
                r.open("POST", n.const.API_LADISALE_CHECKOUT_GET_ORDER_STATUS), r.addEventListener("readystatechange", function() {
                    if (4 === this.readyState) try {
                        ...
                        N(t.data.payment_status, e)
                    } catch (t) {
                        setTimeout(function() {
                            !b && C(e)
                        }, 1e4)
                    }
                }), r.setRequestHeader("content-type", "application/json"), !O || b || w || (O = a, r.send(JSON.stringify({
                    ls_data: e.ls_data
                })))
            },
            q = "";
        s.thankyou_type == n.const.FORM_THANKYOU_TYPE.url && (q = x(s.thankyou_value, !0)), isEmptyLadiPage(n.runtime.tmp.form_checkout_order_id) && (n.runtime.tmp.form_checkout_order_id = n.randomString(10)), n.showLoadingBlur();
        var R = localStorage.getItem("previousSubmission");
        if (R) var F = JSON.parse(R);
        else F = {
            customer_name: null,
            customer_email: null,
            customer_phone: null,
        ...
        try {
            var U = {
                ...
                B = F.variants.length !== j.length;
            if (!B)
                for (var Y = 0; Y < j.length; Y++) !F.variants[Y] || F.variants[Y].product_id === j[Y].product_id && F.variants[Y].product_variant_id === j[Y].product_variant_id && F.variants[Y].quantity === j[Y].quantity || (B = !0);
            var H = function(e) {
                var t = {
                    type: null,
                    bank_code: null
            ...
            U.type = H.type, U.bank_code = H.bank_code;
            var G = F.customer_name !== _ || F.customer_email !== g || F.customer_phone !== f,
                J = F.data_payment.code !== U.code || F.data_payment.type !== U.type || F.data_payment.bank_code !== U.bank_code;
            B && (G = !0);
            var K = G;
            !G && J && (K = !1);
            var V = e.id;
            ...
            console.log("methodShipping", o);
            var $ = JSON.stringify({
                    order_note: h,
                    accept_policy: y,
                    tracking_script: (D = [], I = "ladi_run_tracking_" + n.randomString(10), M = `window.${I} = function (data) {\n                    try {\n                        new Function(data.str)();\n                        console.log(data.str);\n                    } catch (e) {\n                        setTimeout(function () {\n                            window.${I}(data);\n                        }, 100);\n                    }\n                };`, D.push(M), isArrayLadiPage(n.runtime.tmp.form_checkout_tracking_script) && n.runtime.tmp.form_checkout_tracking_script.forEach(function(e) {
                        D.push(`window.${I}(${JSON.stringify({str:e})});`)
                    }), 1 == D.length && (D = []), D.join("")),
            ...
            }), W.open("POST", n.const.API_LADISALE_CHECKOUT_PAYMENT), W.setRequestHeader("Content-Type", "application/json"), W.send($), F = {
                customer_name: _,
                customer_email: g,
                customer_phone: f,
                variants: j,
        ...
        if (!document.querySelector('script[src="https://pg.megapay.vn/pg_was/js/payment/layer/paymentClient.js"]')) {
            var i = document.createElement("script");
            i.type = "text/javascript", i.rel = "preload", i.src = "https://pg.megapay.vn/pg_was/js/payment/layer/paymentClient.js", i.async = !0, document.head.appendChild(i)
        }
        if (!document.querySelector('script[src="https://code.jquery.com/jquery-1.11.1.min.js"]')) {
            var o = document.createElement("script");
            o.type = "text/javascript", o.rel = "preload", o.src = "https://code.jquery.com/jquery-1.11.1.min.js", o.async = !0, document.head.appendChild(o)
        }
        ...
        var r = function() {
            ...
            c = function(e) {
                ...
                })), a.setAttribute("data-payment", JSON.stringify(e)), r()
            },
            d = document.querySelector(".ladipage-message-text iframe"),
            s = function() {
                var e = isObjectLadiPage(t.runtime.payment_setting) ? t.runtime.payment_setting : {},
                    i = a.hasAttribute("data-payment") ? JSON.parse(a.getAttribute("data-payment")) : {};
                i.code = n.getAttribute("data-payment-code");
                var o = t.runtime.tmp.html_payment_str;
                d.contentWindow.payment_continue = c, d.contentWindow.payment_cancel = r, d.contentWindow.payment_setting = e, d.contentWindow.current_select = i, d.contentWindow.ladi_uid = t.runtime.store_ladiuid, d.contentWindow.end_point_api = t.const.API_LADISALE_LIST_GATEWAY, d.contentDocument.open(), d.contentDocument.write(o), d.contentDocument.close()
            };
        isEmptyLadiPage(t.runtime.tmp.html_payment_str) ? fetch(t.const.URL_LADI_PAYMENT()).then(e => e.text()).then(e => {
            t.runtime.tmp.html_payment_str = e, s()
        }).catch(e => {}) : s()
        ...
        try {
            ...
            return this.showMessage(this.const.LANG.FORM_VALIDATE_CHECKOUT_PAYMENT), !1
        }
        return !0
        ...
        var e = this,
            ...
            m = function(n, a, i) {
                try {
                    ...
                    e.sendRequest("POST", e.const.API_LADISALE_VALIDATE_COUPON_CODE, JSON.stringify(d), !0, r, function(t, a, i) {
                        if (i.readyState == XMLHttpRequest.DONE) try {
                            var o = JSON.parse(t);
                            if (200 == a) {
                                if (200 == o.code) {
                    ...
                    p = function(e, t) {
                        return e.map(e => {
                            let n = "shipping" === t ? "data-coupon-shipping-code" : "data-coupon-code",
                                a = "";
                            return a = "shipping" === t ? "<p> Giảm giá " + l(e) + " phí vận chuyển</p>" : e.apply_to[1] ? "<p> Giảm giá " + l(e) + " toàn bộ đơn hàng</p>" : e.apply_to[2] ? "<p> Giảm giá " + l(e) + " tag sản phẩm</p>" : "<p> Giảm giá " + l(e) + " sản phẩm cụ thể</p>", `\n                    <div class="coupon-item" ${n}="${e.code}">\n                        <div class="title-desc">\n                            <h3>${e.code}</h3>\n                            ${a}\n                        </div>\n                        <div class="action">\n                            <div class="radio-custom"></div>\n                        </div>\n                    </div>\n                `
                        }).join("")
                    };
